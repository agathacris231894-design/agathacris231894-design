...
```
Sou estudante apaixonada por tecnologia com foco em desenvolvimento backend e análise de dados.
Tenho facilidade em aprender novas tecnologias, pensamento lógico forte e experiência em
resolver problemas complexos. Busco oportunidades para crescer profissionalmente e 
...
| 📊 **Análise de Dados** | Tratamento, visualização e interpretação |
| 🔍 **Pesquisa & Organização** | Busca, coleta e organização de informações |
| 💬 **Comunicação** | Facilidade em expressar ideias e trabalhar em equipe |
| ⚡ **Aprendizado Rápido** | Capacidade de absorver novos conceitos rapidamente |
...
|--------|-------|
| 🇧🇷 Português | Nativo |
| 🇺🇸 Inglês | Avançado (Leitura, Escrita, Compreensão) |
...
### 🔬 Iniciação Científica - Análise de Dados Genéticos
**UFSCar Sorocaba** | 2023 - 2024
 
Projeto de IC desenvolvido para processar, analisar e interpretar dados genéticos com foco na construção de **árvores filogenéticas** para estudo de relações evolutivas entre espécies.
 
**Objetivo:**
- 📥 Tratamento de dados genéticos (sequências DNA/RNA)
- 🔬 Análise comparativa entre sequências
- 🌳 Geração de árvores filogenéticas
- 📈 Interpretação de relações evolutivas
...
**Funcionalidades:**
- ✅ Importação de dados (FASTA, CSV)
- ✅ Limpeza e tratamento de dados
- ✅ Alinhamento de sequências
- ✅ Cálculo de distância genética
- ✅ Geração e visualização de árvores filogenéticas
---
 
## 📈 O Que Estou Aprendendo
 
- 🗄️ Aprimorando conhecimentos em **banco de dados**
- 🖥️ Explorando **sistemas operacionais**
- 🏗️ Estudando **engenharia de software**
- 📝 Desenvolvendo proficiência em **C**
